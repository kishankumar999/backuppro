  ...
  <div class="mb-4 mt-10 max-w-full gap-2 px-5 md:max-w-2xl">
      ...
      <div class="flex-1 p-4">
        ...
        <div class="font-semibold3 text-sm text-slate-800">
          ...
          <ul class="ml-4 flex list-disc flex-col gap-2">
            <li>
              Navigate to
              <a class="text-sky-600 underline" href="https://console.developers.google.com/apis/" target="_blank">https://console.developers.google.com/apis/</a>
            </li>
    ...
    <div class="mt-10 flex w-full gap-4 rounded-xl border bg-white shadow">
      ...
      <div class="flex-1 p-4">
        ...
        <div class="font-semibold3 text-sm text-slate-800 my-10">
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
            ...
            <div>
                <input type="submit" value="Upload"
                       class="px-4 w-full py-2 bg-blue-500 text-white rounded hover:bg-blue-600 cursor-pointer">
            </div>
        </form>
