...
<div class="max-w-xl mx-auto">
  ...
  <div class="flex justify-center mb-3 gap-2 items-center">
    ...
    <div class="text-bold text-lg text-gray-500">Email Notification Tabs</div>
  </div>
  <?php
  // JSON structure containing tab data
  $tabs = '[
        {"label": "Enable/Disable Notifications", "page": "enable_disable_email_notification.php"},
          {"label": "Subscribers", "page": "subscribers.php"},
          {"label": "Email TemplateTemplate", "page": "notifications.php"}
        ]';
